...
local fzf_keymaps = {
	...
	{
		keys = '<leader>fx',
		func = function() fzf.files  { cwd = '~' } end,
		desc = 'Global [Fzf]',
	},
	{
		keys = '<leader>fC',
		func = function() fzf.files  { cwd = '~/.config' } end,
		desc = 'Config [Fzf]',
	},
	...
	{
		keys = '<leader>flW',
		func = fzf.lsp_live_workspace_symbols,
		desc = 'LSP Workspace Symbols (live query) [Fzf]',
	},
	...
	{
		keys = '<leader>flg',
		func = fzf.lsp_document_diagnostics,
		desc = 'LSP Diagnostics Document [Fzf]',
	},
	{
		keys = '<leader>flG',
		func = fzf.lsp_workspace_diagnostics,
		desc = 'LSP Diagnostics Workspace [Fzf]',
	},
