...
local keymaps = {
	...
	-- Restart Neovim
	{ keys = '<Leader><Space>r', func = '<CMD>restart<CR>', desc = 'Restart Neovim' },
	...
	{ keys = '<Leader><Space>y', func = '"+y', desc = 'Yank to 󰐕 clipboard' },
	{ keys = '<Leader><Space>p', func = '"+p', desc = 'Put from 󰐕 clipboard' },
